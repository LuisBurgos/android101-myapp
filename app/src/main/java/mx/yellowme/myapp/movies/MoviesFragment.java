...
public class MoviesFragment  extends Fragment implements MoviesContract.View {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mActionsListener = new MoviesPresenter(Injection.provideMoviesInteractor(getContext()), this);
    ...
    public void setProgressIndicator(final boolean active) {
        if(active){
            mProgressDialog.setMessage("Cargando películas");
    ...
    public void showMovieDetailUI(String id) {
        Snackbar.make(getView(), "Mostrando película con ID: " + id, Snackbar.LENGTH_SHORT).show();
    }
